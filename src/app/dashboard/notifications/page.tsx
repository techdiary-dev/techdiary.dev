...
/** Text after the actor (actor shown semibold separately). Keys mirror full-sentence i18n with leading actor omitted. */
    ...
    <div className="mx-auto max-w-2xl">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {hasItems && (
          ...
          >
            <CheckCheck className="size-4 mr-1.5 opacity-80" />
            {_t("Mark all as read")}
          </Button>
        )}
      </div>
      ...
      {feedQuery.isError && (
        <div
          className="mt-6 flex flex-col gap-3 border-b border-destructive/30 pb-4 sm:flex-row sm:items-center sm:justify-between"
          role="alert"
        >
      ...
      {showNotificationList && (
        <ul
          className="mt-4 list-none divide-y divide-border border-t border-border p-0"
